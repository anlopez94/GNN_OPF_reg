...
class GNN(tf.keras.Model):
    def __init__(
        ...
        **kwargs,
        ...
        self.readout = layers.Dense(units=1, name="logits")
        self.normalize = normalize
        # self.ffn_prepare = create_ffn(hidden_units, dropout_rate)
        self.update_fn = self.create_ffn(self.hidden_units, self.dropout_rate)
    ...
    def prepare(self, nodes_features, edges, edge_weights, num_nodes):
        ...
        padding = [[0, 0], [0, 32 - node_repesentations.shape[1]]]
    ...
    def create_ffn(self, hidden_units, dropout_rate, name=None):
        ...
        for units in hidden_units:
            ...
            fnn_layers.append(layers.Dense(units, activation=tf.nn.gelu, kernel_initializer=self.hidden_layer_initializer,))
...
class GNN_v2(tf.keras.Model):
    def __init__(
        ...
        **kwargs,
        ...
        super(GNN_v2, self).__init__(*args, **kwargs)
        ...
        self.node_state_size = node_state_size
        self.message_iterations = message_iterations
        self.hidden_units_readout = hidden_units_readout
        self.hidden_units_update = hidden_units_update
        self.activation_fn = activation_fn
        # if (activation_fn == 'tanh'):
        #     self.activation_fn = tf.nn.tanh
